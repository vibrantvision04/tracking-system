...
CREATE TABLE IF NOT EXISTS route_type_vehicle_types (
    ...
    route_type_id INT NOT NULL REFERENCES route_types_swift(id) ON DELETE CASCADE,
    vehicle_type_id INT NOT NULL REFERENCES vehicle_types_swift(id) ON DELETE CASCADE,
