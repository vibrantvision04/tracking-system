...
CREATE TABLE IF NOT EXISTS route_types_swift (
...
INSERT INTO route_types_swift (id, name, is_active) VALUES
  (1, 'D2D',        true),
  (2, 'SWEEPING',   true),
  (3, 'DUSTBIN',    true),
  (4, 'COMMERCIAL', true)
...
SELECT setval('route_types_swift_id_seq', (SELECT MAX(id) FROM route_types_swift));
...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE routes
      ...
      REFERENCES route_types_swift(id)
      ON DELETE SET NULL;
  END IF;
END;
$$;
