...
export default function DriverAttendanceScreen({ navigation }: any) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Error', err?.error || err?.message || 'Failed to submit driver attendance');
    } finally {
      setLoading(false);
    }
  };
      ...
      <View style={styles.card}>
        ...
        {step === 'select_driver' && (
          <View style={styles.stepContainer}>
            <Text style={styles.description}>
              Search and select the driver and vehicle to start the verification process.
            </Text>
            ...
            {loadingData ? (
              ...
              <>
                ...
                <View style={styles.inputContainer}>
                  ...
                  <TextInput
                    style={styles.input}
                    placeholder="Enter Registration No (e.g. RJ47)"
                    value={vehicleSearch}
                    onChangeText={(text) => {
        ...
        {step === 'gps' && (
          <View style={styles.stepContainer}>
            ...
            <Text style={styles.description}>
              Verify coordinates to ensure attendance is recorded from the assigned ward area.
            </Text>
        ...
        {step === 'form' && (
          <View style={styles.stepContainer}>
            <Text style={styles.subtitle}>Driver: {driverName}</Text>
            <Text style={styles.subtitle}>Vehicle: {selectedVehicle?.registration_no}</Text>
            <Text style={styles.description}>Details and Photo Captured successfully.</Text>
        ...
        {step === 'success' && (
          <View style={styles.stepContainer}>
            ...
            <Text style={styles.successSubtitle}>
              Driver and helper attendance marked successfully by Supervisor.
            </Text>
