...
const DUMMY_PAYMENT_DATA: SurveyPaymentRow[] = [
  {
    ...
    totalPayment: 675,
    paymentStatus: "Paid",
    remarks: "June batch 3 — completed",
  },
  {
    id: 2,
    date: "2026-06-23",
    supervisorName: "Vinod Yadav",
    zoneName: "HMZ",
    wardName: "Ward 10",
    totalSurveys: 38,
    ratePerSurvey: 15,
  ...
  },
  {
    ...
    remarks: "Awaiting zone manager approval",
  },
  {
    id: 5,
    date: "2026-06-21",
    ...
    totalPayment: 615,
    paymentStatus: "Paid",
    remarks: "June batch 2 — completed",
  },
  {
    id: 6,
    date: "2026-06-21",
  ...
  },
  {
    ...
    totalPayment: 705,
    paymentStatus: "Paid",
    remarks: "June batch 1 — completed",
  },
  {
    id: 8,
    date: "2026-06-20",
    ...
    totalPayment: 330,
    paymentStatus: "Processing",
    remarks: "Under review by accounts",
  },
  {
    id: 9,
    date: "2026-06-19",
  ...
  },
  {
    ...
    totalPayment: 540,
    paymentStatus: "Pending",
    remarks: "Awaiting supervisor confirmation",
  },
  {
    id: 11,
    date: "2026-06-18",
  ...
  },
  {
    ...
    totalPayment: 270,
    paymentStatus: "Pending",
    remarks: "Data discrepancy flagged",
  },
];
...
export default function SurveyPaymentReportPage() {
  ...
  const loadReport = async () => {
    ...
    setHasLoaded(true);
    try {
      // Simulate API delay, then use dummy data with client-side filtering
      await new Promise((resolve) => setTimeout(resolve, 600));

      // Find zone/ward names from loaded data for filtering
      const selectedZoneName = zones.find((z) => String(z.id) === selectedZone)?.region_name || "";
      const selectedWardName = wards.find((w) => String(w.id) === selectedWard)?.region_name || "";

      let filtered = [...DUMMY_PAYMENT_DATA];

      // Apply filters
      if (selectedZoneName) {
        filtered = filtered.filter((r) => r.zoneName === selectedZoneName);
      }
      if (selectedWardName) {
        filtered = filtered.filter((r) => r.wardName === selectedWardName);
      }
      if (selectedSupervisor) {
        filtered = filtered.filter((r) => r.supervisorName === selectedSupervisor);
      }
      if (selectedStatus) {
      ...
      if (filtered.length > 0) {
        toast.success(`Loaded ${filtered.length} payment record(s).`);
      } else {
