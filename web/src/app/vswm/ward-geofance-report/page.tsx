        ...
        <Card className="border border-slate-200 bg-white rounded-xl shadow-sm print:hidden">
          <CardContent className="p-6">
            ...
            <div className="flex justify-start pt-4 border-t border-slate-100">
              <Button onClick={loadReport} variant="success" loading={loading} loadingText="Loading..." className="text-white font-semibold px-5 py-2 rounded-lg text-xs transition">
                Load
              </Button>
            </div>
          </CardContent>
