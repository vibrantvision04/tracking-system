...
export default function EmployeeFormPage() {
  ...
  useEffect(() => {
    ...
    const fetchEmployee = async () => {
      try {
        ...
        router.push("/vswm/employee-management/employees");
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const token = typeof window !== "undefined" ? localStorage.getItem("vswm_access_token") : null;
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-theme-base text-theme-text overflow-hidden font-sans space-y-6 p-6 lg:p-8">
      <PageHeader
        ...
        breadcrumbs={[
          { label: "Employee Management", href: "/vswm/employee-management/employees" },
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <Button
              type="button"
              variant="outline"
              onClick={() => router.push("/vswm/employee-management/employees")}
            >
              Cancel
            </Button>
          </div>
