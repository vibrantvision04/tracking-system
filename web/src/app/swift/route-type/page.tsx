  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-theme-base text-theme-text overflow-hidden select-none font-sans space-y-6 p-6 lg:p-8">
      ...
      <PageHeader
        ...
        breadcrumbs={[{ label: "SWIFT", href: "/swift/shift" }, { label: "Route Types" }]}
        actions={
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar space-y-6 pb-8">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between py-4">
            <div><CardTitle>Existing Route Types</CardTitle><CardDescription>All registered route type categories for SWIFT operations.</CardDescription></div>
