...
export default function DepartmentsPage() {
  ...
  return (
    <CrudDirectory
      ...
      description="Manage organizational departments for employee assignment and reporting."
      breadcrumbs={[{ label: "Employee Management", href: "/swift/employee-management/employees" }, { label: "Departments" }]}
