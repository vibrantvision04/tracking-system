...
export default function DashboardCharts() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
      ...
      <div className="p-5 rounded-2xl border border-slate-200/60 bg-gradient-to-br from-white/95 to-slate-50/50 flex flex-col min-h-[200px] h-[280px] shadow-sm hover:shadow-lg transition-all duration-300">
        ...
        <div className="flex-1 w-full min-h-[200px] text-[10px] font-semibold">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={fleetActivityData} margin={{ top: 10, right: 10, left: -25, bottom: 0 }}>
              ...
              <XAxis dataKey="time" stroke="#94A3B8" fontSize={10} tick={{ fontSize: 10 }} interval="preserveStartEnd" />
              ...
              />
              <Legend verticalAlign="top" height={24} iconSize={8} iconType="circle" wrapperStyle={{ fontSize: '12px', fontWeight: 'bold', whiteSpace: 'normal', wordWrap: 'break-word' }} />
