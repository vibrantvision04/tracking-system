  ...
  return (
    <Card hoverable className="p-6 flex flex-col h-full justify-center relative overflow-hidden">
      <div className="flex items-center gap-3.5 mb-5 z-10">
        <div className="p-2.5 bg-[#ef4444]/10 text-[#ef4444] rounded-full border border-[#ef4444]/20 flex items-center justify-center shrink-0">
          <Nfc size={18} />
        </div>
      ...
      <div className="w-full bg-theme-elevated rounded-full h-2.5 mb-1 overflow-hidden z-10">
        <div 
          className="bg-[#ef4444] h-2.5 rounded-full transition-all duration-1000 ease-out" 
