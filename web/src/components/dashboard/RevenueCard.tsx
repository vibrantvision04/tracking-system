    ...
    <Card hoverable className="p-6 flex flex-col justify-between h-full relative overflow-hidden">
      <div className="flex justify-between items-start mb-4 gap-2 z-10">
        ...
        <select 
          ...
          className="text-[10px] font-bold text-theme-text-dim bg-theme-elevated border border-theme-border rounded-md px-2 py-1 outline-none focus:border-[#ef4444] cursor-pointer"
        >
      ...
      <div className="flex items-center gap-3.5 mt-auto pt-2 z-10">
        <div className="p-2.5 bg-[#ef4444]/10 text-[#ef4444] rounded-full border border-[#ef4444]/20 shrink-0 flex items-center justify-center">
