  ...
  return (
    <div ref={containerRef} className={`relative select-none ${className}`}>
      <button
        ...
        className={`w-full bg-white border border-slate-300 px-3 py-1.5 rounded text-sm text-slate-700 hover:border-slate-400 focus:border-emerald-500 outline-none transition cursor-pointer font-medium flex items-center justify-between shadow-sm ${
      ...
      {isOpen && !disabled && (
        <div className="absolute left-0 mt-1 w-full bg-white border border-slate-200 rounded-lg shadow-xl flex flex-col z-[1050] overflow-hidden min-w-[200px]">
          <div className="p-2 border-b border-slate-100 shrink-0 flex items-center gap-1.5 bg-slate-50">
